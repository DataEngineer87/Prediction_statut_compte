...
def encode_features(df, target_col='account_status', alpha=40):
    ...
    ['gender', 'marital_status', 'employment_status', 'education_level',
        'number_of_children', 'subscription_type',
       'age_group', 'children_per_age', 'log_annual_income', 'account_status']
